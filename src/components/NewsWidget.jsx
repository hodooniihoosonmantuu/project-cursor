...
function NewsWidget() {
  ...
  return (
    <div className="widget news-widget" ref={widgetRef}>
      <div className="news-background">
        <img src={articleImage} alt="News" className="news-background-image" />
        <div className="news-overlay"></div>
      </div>
      <div className="news-card">
        <h2 className="news-card-title">Мэдээний гарчиг</h2>
        <p className="news-card-content">
          Мэдээний агуулга Мэдээний агуулга Мэдээний агуулга Мэдээний агуулга Мэдээний агуулга Мэдээний агуулга
        </p>
